<template>
<v-app >
  <v-app-bar app color="grey" dark elevation="1">
  ...
  <v-navigation-drawer app v-model="sidebar" :mini-variant.sync="mini">
    <v-list dense color="grey" dark>
      <v-list-item >
        <v-list-item-action>
          <v-icon @click="sidebar = !sidebar">mdi-chevron-left</v-icon>
        </v-list-item-action>
        <v-list-item-title>
    ...
    <v-list-item class="px-2" @click="mini = !mini">
      ...
      <v-list-item-content>Guinnever C.</v-list-item-content>
  ...
  <v-footer app class="py-3" color="light-grey"><span class="caption">MinhaListaDeTarefas ©2021</span></v-footer>
